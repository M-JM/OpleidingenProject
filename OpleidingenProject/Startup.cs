    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddAuthorization(options => {
                options.AddPolicy("IsUser", policyBuilder => policyBuilder.RequireClaim("IsUser"));
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, UserManager<CustomUser> userManager)
        {
       
            IdentitySeeder.SeedUsers(userManager);
            ...
            app.UseEndpoints(endpoints =>
            {
                endpoints.MapControllerRoute(
                    name: "default",
                    pattern: "{controller=Opleiding}/{action=Index}/{id?}");
